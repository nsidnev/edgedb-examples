...
The global variable names are taken from the 'policies' database in
the EdgeDB test suite.
"""
...
def default_globals() -> dict[str, object]:
    return {"default::filter_owned": True}


# NOTE: app specific
def globals_from_github_profile(profile: dict[str, str]) -> dict[str, object]:
    username = profile["login"]
    # NOTE: A real app likely also wants to check that this
    # corresponds to a real account in the app.
    return {"default::cur_user": username}
